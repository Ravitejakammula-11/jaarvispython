...
def sayit(text):
    ...
    x.say(text)
    if 'master' not in text and 'the end' not in text:
        print(text)
    x.runAndWait()
...
def jarvis(command):
    if 'who are you' in command:
        sayit("Hello, I am 'JARIVIS' a virtual assistant")
    elif 'siri' in command or 'google assistant' in command or 'alexa' in command:
